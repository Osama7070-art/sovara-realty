    ...
    <>
      <section className="hero">
        ...
        <div className="container hero-content">
          ...
          <p>
            A premium real-estate connection platform bringing selected
            properties, independent brokers and buyers together with clarity
            and trust.
          </p>
          ...
          <div className="actions">
            ...
            <Link className="btn" href="/brokers">
              Partner With SOVARA
            </Link>
          </div>
        </div>
        ...
        <div className="container">
          <div className="section-head">
            <div>
              ...
              <h2 className="serif">Featured Properties</h2>
            </div>
      ...
      <section className="section band">
        <div className="container two-col">
          <div>
            ...
            <h2 className="serif">
              Build Your Real Estate Business With SOVARA
            </h2>
          </div>

          <div>
            <p className="muted">
              Join the network, access selected properties, bring your clients
              and work with SOVARA through the transaction.
            </p>
